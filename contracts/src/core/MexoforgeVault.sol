...
/// @title MexoforgeVault — share-based entry vault (ERC-4626-compatible accounting)
/// @notice v0.4 internal QA — deposits route through YieldRouter into isolated markets
contract MexoforgeVault {
    error Paused();
    error ZeroAddress();
    error ZeroAmount();
    error RouterNotSet();
    ...
    string public constant name = "Mexoforge Vault Share";
    string public constant symbol = "mxfVault";
